...
<?php include_once '../../includes/navbar.php'?>
    <div class="container">
        <h1 class="text-center">Formulario para los clientes</h1>
        <div class="row justify-content-center mb-5">
            <form class="col-lg-8 border bg-light p-3">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="cliente_nit">Numero de Nit</label>
                        <input type="number" step="1" min="0" name="cliente_nit" id="cliente_nit" class="form-control">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
